  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        {isSelect ?(
          <select
            className="w-full bg-transparent outline-none border border-gray-300 rounded-md py-2 px-3 text-gray-700 leading focus:border-yellow-600"
            value={value}
          ...
          <input
            ...
            type={type === 'password'? (showPasswword ? 'text':'password'):type}
